...
<div className="container mx-auto max-w-[1216px] px-6 sm:px-6 py-16  max-[680px]:py-10">
    ...
    <div className="flex flex-col gap-10">
      ...
      {/* Testimonial */}
      <div className="flex flex-col lg:flex-row  min-[1500px]:justify-end pl-[120px] max-[1400px]:pl-[80px] max-[1200px]:pl-[40px] max-[767px]:pl-[27px] max-[1200px]:pb-10 max-[1023px]:pb-5 max-[1023px]:mt-0  gap-10 mt-[-120px] pb-20">
